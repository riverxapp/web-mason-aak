...
Validate dev runtime defaults:

```bash
pnpm verify:dev-runtime
```

Dev runtime defaults:

- Host: `0.0.0.0`
- Port: `5173`
- Strict port mode: enabled (fails fast if port is occupied)
- Override examples: `PORT=3001 pnpm dev` or `pnpm dev -- --port 3001`
